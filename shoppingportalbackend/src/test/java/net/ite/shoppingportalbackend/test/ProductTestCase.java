package net.ite.shoppingportalbackend.test;
...
public class ProductTestCase {
	...
	public static void init() {
		...
		context.scan("net.ite.shoppingportalbackend");
		context.refresh();
 ...
 /*	
	...
	public void testCRUDProduct() {
		...
		product.setDescription("This is some Description for oppp mobile phones!");
